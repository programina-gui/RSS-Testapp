(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ApiService = /** @class */ (function () {
                ...
                ApiService.prototype.getFeedContent = function () {
            ...
            var AppComponent = /** @class */ (function () {
                ...
                AppComponent.prototype.refresh = function () {
                    ...
                    this.feedContent$ = this.apiService.getFeedContent()
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (feedContent) { return _this.mapFeedToModel(feedContent); }));
                    setTimeout(function () { _this.spinnerState = false; }, 2000);
                };
                // tslint:disable-next-line: ban-types
                AppComponent.prototype.mapFeedToModel = function (feedContent) {
                ...
                //   }
                // }
                AppComponent.prototype.deleteCard = function (card) {
                    this.cards = this.cards.filter(function (fdEntry) { return fdEntry !== card; });
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FullNewsPopupComponent = /** @class */ (function () {
                function FullNewsPopupComponent(dialogRef, data) {
                ...
                FullNewsPopupComponent.prototype.close = function () {
                    this.dialogRef.close();
                };
                FullNewsPopupComponent.prototype.ngOnInit = function () {
                };
                return FullNewsPopupComponent;
            }());
            FullNewsPopupComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NewsCardComponent = /** @class */ (function () {
                function NewsCardComponent(dialog) {
                    this.dialog = dialog;
                }
                NewsCardComponent.prototype.share = function () {
                    window.open(this.url);
                };
                NewsCardComponent.prototype.cropDescription = function (feedEntry) {
                    var s = feedEntry.description;
                    s = s.substring(0, 180);
                    this.cardDescription = s;
                    this.cardDescription = this.cardDescription + '...';
                };
                NewsCardComponent.prototype.delete = function () {
                    console.log('me wants to delete');
                };
                NewsCardComponent.prototype.openDialog = function (feedEntry) {
                    var data = {
                        feedEntry: this.cardContent
                    };
                    var dialogRef = this.dialog.open(src_app_modals_full_news_popup_full_news_popup_component__WEBPACK_IMPORTED_MODULE_3__["FullNewsPopupComponent"], { data: data });
            ...
            NewsCardComponent.ctorParameters = function () { return [
